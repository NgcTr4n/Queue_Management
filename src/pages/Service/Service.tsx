...
import DevicePage from "../../components/Table/DevicePage/DevicePage";
import ServicePage from "../../components/Table/DevicePage/ServicePage";
            ...
            <div className="container">
                <div className="row">
                    <div className="col">
                        ...
                        <div className="dashboard-statistical row" style={{backgroundColor: '#F6F6F6'}}>
                            <div className="col">
                                <div className="row">
                                    <div className="col-3">
                                        <p>Trạng thái hoạt động</p>
                                        <div className="d-flex align-items-center device-dropdown">
                                            <CustomDropdown options={optionActive} onSelect={handleSelect} />
                                        </div>
                                    </div>
                                    <div className="col-4">
                                        <p>Chọn thời gian</p>
                                ...
                                <div className="row" style={{marginTop: "16px"}}>
                                    <div className="col">
                                     ...
                                     <div className="col-1" style={{marginTop:"15px"}}>
                                        <ButtonAdd btn_name = 'Thêm dịch vụ' showPage="/service/add"/>
                                    </div>
                                </div>
